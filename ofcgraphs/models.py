...
class GraphTemplate(BaseGraphTemplate):
    ...
    title_style = CharField(max_length=255, verbose_name=_('Title Style'), blank=True, null=True,
    ...
    x_legend_style = CharField(max_length=255, verbose_name=_('X Legend Style'), blank=True, null=True,
                               default=DEFAULT_LEGEND_STYLE,
                               help_text=_('Use CSS style (example: {font-size: 30px;background-color: #0000ff;}'))
    y_legend_text = CharField(max_length=255, verbose_name=_('Y Legend Text'))
    y_legend_style = CharField(max_length=255, verbose_name=_('Y Legend Style'), blank=True, null=True,
                               default=DEFAULT_LEGEND_STYLE,
                               help_text=_('Use CSS style (example: {font-size: 30px;background-color: #0000ff;}'))
    bg_colour = ColorField(verbose_name=_('Background Colour'), default='eeeeee')
    x_axis_stroke = IntegerField(validators=[MaxValueValidator(20)], verbose_name=_('X Axis Stroke'), blank=True,
                                 null=True, choices=SIZE_CHOICES)
    x_axis_tick_height = IntegerField(validators=[MaxValueValidator(20)], verbose_name=_('X Axis Stroke Tick Height'),
                                      blank=True, null=True, choices=SIZE_CHOICES)
    ...
    y_axis_stroke = IntegerField(validators=[MaxValueValidator(20)], verbose_name=_('Y Axis Stroke'), blank=True,
                                 null=True, choices=SIZE_CHOICES)
    y_axis_tick_length = IntegerField(validators=[MaxValueValidator(20)], verbose_name=_('Y Axis Tick Length'),
                                      blank=True, null=True, choices=SIZE_CHOICES)
    ...
    y_axis_right_min = IntegerField(verbose_name=_('Y Axis-Right Min'), blank=True, null=True,
                                    help_text=_('Insert min value'))
    y_axis_right_max = IntegerField(verbose_name=_('Y Axis-Right Max'), blank=True, null=True,
                                    help_text=_('Insert Max value'))
    y_axis_right_stroke = IntegerField(validators=[MaxValueValidator(20)], verbose_name=_('Y Axis-Right Stroke'),
                                       blank=True, null=True, choices=SIZE_CHOICES)
    ...
    y_axis_right_tick_length = IntegerField(validators=[MaxValueValidator(20)],
                                            verbose_name=_('Y Axis-Right Tick length '), blank=True, null=True)
    y_axis_right_labels_labels = CharField(max_length=255, verbose_name=_('Y Axis-Right Labels'), blank=True, null=True)
    y_axis_right_labels_colour = ColorField(max_length=255, verbose_name=_('Y Axis-Right Labels Colour'), blank=True,
                                            null=True)
    y_axis_right_offset = BooleanField(verbose_name=_('Y Axis-Right Offset'), default=True)
    y_axis_right_grid_colour = ColorField(max_length=255, verbose_name=_('Y Axis-Right Grid Colour'), blank=True,
                                          null=True)
    ...
    def build_y_axis_right(self):
        ...
        if self.y_axis_right_labels_labels:     yaxr['y_axis_right']['labels'][
            'labels'] = self.y_axis_right_labels_labels
        if self.y_axis_right_labels_colour:     yaxr['y_axis_right']['labels'][
            'colour'] = '#%s' % self.y_axis_right_labels_colour
...
class GraphElementTemplate(BaseGraphTemplate):
    ...
    tooltip = CharField(max_length=100, verbose_name=_('Tooltip'), default=_('#val#'),
    ...
    dot_style_type = CharField(max_length=255, verbose_name=_('Dot-Style Type'), choices=DOT_STYLE_CHOICES, blank=True,
                               null=True)
